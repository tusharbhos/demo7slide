...
export default function Slide4Page() {
  ...
  // 3 Previous Customer Reviews के लिए नया state
  const [reviewsPopup, setReviewsPopup] = useState<{
    ...
    currentIndex: 0,
    images: [
      "assets/accounts/1/coveAi/popup/S7B3SL1_50pct.webp",
      "assets/accounts/1/coveAi/popup/S7B3SL2_50pct.webp",
      "assets/accounts/1/coveAi/popup/S7B3SL3_50pct.webp"
    ]
  });
  ...
  // 3 Previous Customer Reviews के लिए फंक्शंस
  ...
  return (
    <div className="relative w-full h-full">
      ...
      <div className="fixed top-4 right-4 w-[110px] h-[70px] md:w-[130px] md:h-[90px] lg:w-[150px] lg:h-[110px] bg-black rounded-lg overflow-hidden shadow-lg z-40">
        ...
        >
          <source src="/videos/S8.mp4" type="video/mp4" />
      ...
      <div className="relative z-30 w-full h-full flex flex-col items-center justify-center px-4 py-8 md:py-0">
        ...
        <div className="md:hidden w-full h-full  py-20">
          <div className="flex flex-col items-center justify-start gap-6 w-full max-w-xs mx-auto pb-10">
            ...
            {/* Single Button - Typical Resident Profile */}
            <button
              onClick={() =>
                setInfoPopup({
                  image: "assets/accounts/1/coveAi/popup/S7B1P1_50pct.webp",
                })
              }
            ...
            {/* Single Button - Lifestyle Match */}
            <button
              onClick={() =>
                setInfoPopup({
                  image: "assets/accounts/1/coveAi/popup/S7B2P1_50pct.webp",
                })
              }
            ...
            {/* Single Button - 3 Previous Customer Reviews */}
            <button
              onClick={openReviewsPopup}
              className="w-full py-3 px-4 rounded-xl border-2 border-orange-500 bg-white text-orange-600 font-semibold text-sm shadow-md hover:bg-orange-500 hover:text-white transition active:scale-95"
            >
              3 Previous Customer Reviews
            </button>
            {/* Single Button - Possession as per RERA */}
            <button
              onClick={() =>
                setInfoPopup({
                  image: "assets/accounts/1/coveAi/popup/S7B4P1_50pct.webp",
                })
              }
              className="w-full py-3 px-4 rounded-xl border-2 border-orange-500 bg-white text-orange-600 font-semibold text-sm shadow-md hover:bg-orange-500 hover:text-white transition active:scale-95"
            >
      ...
      {/* 3 PREVIOUS CUSTOMER REVIEWS CAROUSEL POPUP */}
      {reviewsPopup.isOpen && (
            ...
            <div className="flex flex-col items-center">
              ...
              <div className="relative w-full">
                ...
                <button
                  ...
                  disabled={reviewsPopup.currentIndex === 0}
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    className="h-8 w-8"
                ...
                <div className="overflow-hidden rounded-xl shadow-2xl mx-16">
                  <img
                    src={reviewsPopup.images[reviewsPopup.currentIndex]}
                    alt={`Customer Review ${reviewsPopup.currentIndex + 1}`}
                ...
                <button
                  ...
                  disabled={reviewsPopup.currentIndex === reviewsPopup.images.length - 1}
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    className="h-8 w-8"
              ...
              <div className="flex gap-3 mt-6">
                {reviewsPopup.images.map((_, index) => (
                  <button
                    key={index}
                    onClick={() => setReviewsPopup(prev => ({
                      ...prev,
                      currentIndex: index
                    }))}
                    className={`w-3 h-3 rounded-full transition ${
                      index === reviewsPopup.currentIndex 
                        ? "bg-white" 
              ...
              <div className="mt-4 text-white text-sm">
                {reviewsPopup.currentIndex + 1} / {reviewsPopup.images.length}
              </div>
            </div>
          </div>
        </div>
