  ...
  return (
    <div className="relative w-full h-full">
      ...
      <div className="fixed top-4 right-4 w-[110px] h-[70px] md:w-[130px] md:h-[90px] lg:w-[150px] lg:h-[110px] bg-black rounded-lg overflow-hidden shadow-lg z-40">
        ...
        >
          <source src="/videos/S7.mp4" type="video/mp4" />
      ...
      <div className="relative z-30 w-full h-full flex flex-col items-center justify-center px-4 py-8 md:py-0">
        ...
        <div className="md:hidden w-full h-full  py-20">
          <div className="flex flex-col items-center justify-start gap-6 w-full max-w-xs mx-auto pb-10">
            ...
            {/* Single Button - Construction Stage */}
            <button
              onClick={() =>
                setInfoPopup({
                  image: "assets/accounts/1/coveAi/popup/S6B1P1_50pct.webp",
                })
              }
            ...
            {/* Single Button - Amenity Activation */}
            <button
              onClick={() =>
                setInfoPopup({
                  image: "assets/accounts/1/coveAi/popup/S6B2P1_50pct.webp",
                })
              }
            ...
            {/* Single Button - Noise Sensitivity */}
            <button
              onClick={() =>
                setInfoPopup({
                  image: "assets/accounts/1/coveAi/popup/S6B3P1_50pct.webp",
                })
              }
              className="w-full py-3 px-4 rounded-xl border-2 border-orange-500 bg-white text-orange-600 font-semibold text-sm shadow-md hover:bg-orange-500 hover:text-white transition active:scale-95"
            >
            ...
            {/* Single Button - Visitor Parking */}
            <button
              onClick={() =>
                setInfoPopup({
                  image: "assets/accounts/1/coveAi/popup/S6B4P1_50pct.webp",
                })
              }
              className="w-full py-3 px-4 rounded-xl border-2 border-orange-500 bg-white text-orange-600 font-semibold text-sm shadow-md hover:bg-orange-500 hover:text-white transition active:scale-95"
            >
            ...
            {/* Single Button - Society Rules */}
            <button
              onClick={() =>
                setInfoPopup({
                  image: "assets/accounts/1/coveAi/popup/S6B5P1_50pct.webp",
                })
              }
              className="w-full py-3 px-4 rounded-xl border-2 border-orange-500 bg-white text-orange-600 font-semibold text-sm shadow-md hover:bg-orange-500 hover:text-white transition active:scale-95"
            >
