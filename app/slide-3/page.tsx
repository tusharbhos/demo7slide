  ...
  return (
    <div className="relative w-full h-full">
     ...
     {/* Title - Fixed at top with improved positioning */}
      ...
      {/* MAIN BUTTONS LAYOUT - Center aligned like image.png */}
      <div className="absolute inset-0 z-20 flex flex-col items-center justify-center px-4">
        {/* Mobile view: 1 column (6 buttons stacked) */}
        <div className="flex flex-col items-center justify-center gap-4 w-full max-w-xs md:hidden">
          <button
            onClick={() =>
              setInfoPopup({
                image: "assets/accounts/1/coveAi/popup/S2B1P1_50pct.webp",
              })
            }
          ...
          <button
            onClick={() =>
              setInfoPopup({
                image: "assets/accounts/1/coveAi/popup/S1B2P1_50pct.webp",
              })
            }
            className="w-full py-3 px-4 rounded-xl border-2 border-orange-500 bg-white text-orange-600 font-semibold text-sm shadow-md hover:bg-orange-500 hover:text-white transition active:scale-95"
          >
          ...
          <button
            onClick={() =>
              setInfoPopup({
                image: "assets/accounts/1/coveAi/popup/S1B3P1_50pct.webp",
              })
            }
            className="w-full py-3 px-4 rounded-xl border-2 border-orange-500 bg-white text-orange-600 font-semibold text-sm shadow-md hover:bg-orange-500 hover:text-white transition active:scale-95"
          >
        ...
        {/* Desktop view: 3 rows with 2 buttons each - EXACTLY LIKE IMAGE.PNG */}
        <div className="hidden md:flex flex-col items-center justify-center gap-5 lg:gap-6 w-full max-w-4xl mx-auto">
          {/* First row - 2 buttons */}
          <div className="flex items-center justify-center gap-5 lg:gap-8 w-full">
            <button
              onClick={() =>
                setInfoPopup({
                  image: "assets/accounts/1/coveAi/popup/S2B1P1_50pct.webp",
              ...
              className="py-3 px-6 rounded-xl border-2 border-orange-500 bg-white text-orange-600 font-semibold text-base shadow-md hover:bg-orange-500 hover:text-white transition hover:scale-105 min-w-[180px] lg:min-w-[200px] flex-1"
            >
              Nearest Work Zones
            </button>
            <button
              onClick={() =>
                setInfoPopup({
                  image: "assets/accounts/1/coveAi/popup/S2B2P1_50pct.webp",
                })
              }
              className="py-3 px-6 rounded-xl border-2 border-orange-500 bg-white text-orange-600 font-semibold text-base shadow-md hover:bg-orange-500 hover:text-white transition hover:scale-105 min-w-[180px] lg:min-w-[200px] flex-1"
            >
          ...
          <div className="flex items-center justify-center gap-5 lg:gap-8 w-full">
            <button
              onClick={() =>
                setInfoPopup({
                  image: "assets/accounts/1/coveAi/popup/S2B3P1_50pct.webp",
                })
              }
              className="py-3 px-6 rounded-xl border-2 border-orange-500 bg-white text-orange-600 font-semibold text-base shadow-md hover:bg-orange-500 hover:text-white transition hover:scale-105 min-w-[180px] lg:min-w-[200px] flex-1"
            >
